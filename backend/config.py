...
CORS_ORIGINS = os.getenv("CORS_ORIGINS", "http://localhost:8501,http://127.0.0.1:8501,http://localhost:3000,https://stock-prediction-2g25.onrender.com,http://51.20.120.226:3000").split(",")